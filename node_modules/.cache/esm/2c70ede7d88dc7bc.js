let express,http,io,uuidv1;_d88‍.w("express",[["default",["express"],function(v){express=v}]]);_d88‍.w("http",[["default",["http"],function(v){http=v}]]);_d88‍.w("socket.io",[["default",["io"],function(v){io=v}]]);_d88‍.w("uuid/v1",[["default",["uuidv1"],function(v){uuidv1=v}]]);// express for creating the server
...
socketIo.on("connection", socket => {
  ...
  socket.on('join_game', data => {
    ...
    _d88‍.g.console.log('entro ',games[data.gameKey].playerTwo,' a ',data.gameKey);
    // broadcast games to current users
    socketIo.emit("game_update", games);
  });

  socket.on('leave_game', data => {
    _d88‍.g.console.log('salio ',games[data.gameKey].playerTwo, ' de ',data.gameKey);
